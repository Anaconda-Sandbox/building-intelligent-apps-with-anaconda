...
- [ ] conda-forge release: create a pinned version where everything is conda-forge, then push a release that is all anaconda channels. 
    ...
    - [ ] update all of the environment.yml for other version so its only conda-forge and conda-pypi
...
- [ ] Add `opinions` section to README - MetaFlow, conda-first ecosystem, trust security first package sources, see conda-forge pin for conda-forge version of this repo.
...
- [ ] 03, 05, 06, 07, 08, 09: Complete the tutorials and make sure they run
    ...
    - [ ] 05: The entire environment.yml is wild -- make it so it uses conda-forge + nvidia channels for one version and conda-pypi, defaults, main-x and nvidia channels for the other version
    ...
    - [ ] 07: remove pip and make it conda-pypi in environment.yml
    ...
    - [ ] 09: Add environment.yml for this directory
...
# COMPLETE
- [ x] MAIN README: Update README to reflect all the changes and have a chart for how long it took you to get there.
